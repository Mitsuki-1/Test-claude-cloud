...
(function () {
  ...
  Object.assign(D.ru, {
    "hero.title": "Одежда из Турции, в которой детям <em class=\"rot\">уютно</em>",
    "hero.words": "уютно|мягко|тепло|красиво",
    "stat.year": "лет бренду Caramell", "stat.shops": "магазина в Ташкенте", "stat.subs": "подписчиков в Telegram", "stat.tr": "фабрика в Турции",
    "hot.kicker": "Хит недели", "hot.cta": "Выбрать",
    "top.1": "🚚 Доставка по всему Узбекистану", "top.2": "📦 Опт и розница", "top.3": "🇹🇷 Оригинал из Турции",
    "reels.kicker": "Caramell Reels", "reels.title": "Смотрите вживую — как в магазине",
    "reels.sub": "Настоящие видео из наших магазинов и новых коллекций. Нажмите, чтобы смотреть как сторис.",
    "reels.order": "Заказать в Telegram", "reels.more": "Больше видео в канале",
    "r1": "Модели для девочек и мальчиков — на каждый день и для особых моментов",
    "r2": "Нежный и практичный набор — всё, что нужно малышу для выписки",
    "r3": "Вязаные пледы для малышей. Доставка по всему Узбекистану",
    "r4": "Осенняя коллекция Caramell уже в магазинах 🍂",
    "r5": "Стильно и комфортно — одежда для осеннего сезона",
    "r6": "Мягкость, нежность и забота в каждой детали ❤️",
    "r7": "Скоро: новые коллекции Sweet Me 😍",
    "b.kicker": "Конструктор", "b.title": "Соберите набор на выписку за 10 секунд",
    "b.sub": "Реальные комплекты из нашего Telegram. Выберите вариант — итог посчитается сам.",
    "b.step1": "Для кого", "b.boy": "Для мальчика", "b.girl": "Для девочки",
    "b.step2": "Добавить к комплекту", "b.plaid": "Вязаный плед в тон", "b.size": "Размер: 0–1 месяц",
    "b.total": "Итого за набор", "b.add": "Добавить набор в корзину", "b.added": "Набор добавлен в корзину",
    "b.inc": "В комплекте: вязаный комбинезон, базовый комбинезон/боди и шапочка",
    "shops.kicker": "Приходите в гости", "shops.title": "4 магазина Caramell в Ташкенте",
    "shops.open": "Открыто сейчас", "shops.closed": "Сейчас закрыто", "shops.route": "Маршрут",
    "shop.1": "Яккасарайский район, ул. Нукус, 15Б", "shop.2": "Алмазарский район, массив Себзар", "shop.2n": "Ориентир: Себзар корзинка",
    "shop.3": "ТРЦ Chimgan, Мирзо-Улугбекский район, ул. Темура Малика, 3А", "shop.4": "Торговый центр Riviera",
    "soon.kicker": "Скоро в Caramell", "soon.title": "Новая коллекция <em>Sweet Me</em>",
    "soon.sub": "Одна красивее другой — первыми узнайте о поступлении в нашем Telegram-канале.", "soon.cta": "Подписаться на канал",
    "fav.title": "Избранное", "fav.add": "Добавлено в избранное", "fav.rm": "Убрано из избранного", "fav.empty": "Нажмите ♡ на товаре, чтобы сохранить его здесь.",
    "cat.fav": "♡ Избранное", "nav.tg": "Telegram"
  });
  Object.assign(D.uz, {
    "hero.title": "Bolalarga <em class=\"rot\">qulay</em> bo‘lgan Turkiya kiyimlari",
    "hero.words": "qulay|yumshoq|issiq|chiroyli",
    "stat.year": "yil Caramell brendiga", "stat.shops": "ta do‘kon Toshkentda", "stat.subs": "Telegram obunachilari", "stat.tr": "Turkiyadagi fabrika",
    "hot.kicker": "Hafta xiti", "hot.cta": "Tanlash",
    "top.1": "🚚 O‘zbekiston bo‘ylab yetkazib berish", "top.2": "📦 Ulgurji va chakana", "top.3": "🇹🇷 Turkiyadan original",
    "reels.kicker": "Caramell Reels", "reels.title": "Jonli ko‘ring — xuddi do‘kondagidek",
    "reels.sub": "Do‘konlarimiz va yangi kolleksiyalardan haqiqiy videolar. Storis kabi ko‘rish uchun bosing.",
    "reels.order": "Telegramda buyurtma", "reels.more": "Kanalda ko‘proq video",
    "r1": "Qiz va o‘g‘il bolalar uchun modellar — har kuni va alohida lahzalar uchun",
    "r2": "Nozik va amaliy to‘plam — chiqish uchun chaqaloqqa kerak bo‘lgan hamma narsa",
    "r3": "Chaqaloqlar uchun to‘qilgan ko‘rpachalar. O‘zbekiston bo‘ylab yetkazib berish",
    "r4": "Caramell kuzgi kolleksiyasi do‘konlarda 🍂",
    "r5": "Zamonaviy va qulay — kuz mavsumi uchun kiyimlar",
    "r6": "Har bir detalda mayinlik, nozik va g‘amxo‘rlik ❤️",
    "r7": "Tez kunda: Sweet Me yangi kolleksiyalari 😍",
    "b.kicker": "Konstruktor", "b.title": "Chiqish to‘plamini 10 soniyada yig‘ing",
    "b.sub": "Telegramimizdagi haqiqiy to‘plamlar. Variantni tanlang — jami o‘zi hisoblanadi.",
    "b.step1": "Kim uchun", "b.boy": "O‘g‘il bola uchun", "b.girl": "Qiz bola uchun",
    "b.step2": "To‘plamga qo‘shish", "b.plaid": "Mos to‘qilgan ko‘rpacha", "b.size": "O‘lcham: 0–1 oy",
    "b.total": "To‘plam jami", "b.add": "To‘plamni savatga qo‘shish", "b.added": "To‘plam savatga qo‘shildi",
    "b.inc": "To‘plamda: to‘qilgan kombinezon, asosiy kombinezon/bodi va shapkacha",
    "shops.kicker": "Mehmonga keling", "shops.title": "Toshkentda 4 ta Caramell do‘koni",
    "shops.open": "Hozir ochiq", "shops.closed": "Hozir yopiq", "shops.route": "Yo‘nalish",
    "shop.1": "Yakkasaroy tumani, Nukus ko‘chasi, 15B", "shop.2": "Olmazor tumani, Sebzor massivi", "shop.2n": "Mo‘ljal: Sebzor korzinka",
    "shop.3": "Chimgan SEM, Mirzo Ulug‘bek tumani, Temur Malik ko‘chasi, 3A", "shop.4": "Riviera savdo markazi",
    "soon.kicker": "Tez kunda Caramell’da", "soon.title": "Yangi <em>Sweet Me</em> kolleksiyasi",
    "soon.sub": "Biri biridan chiroyli — kelishi haqida Telegram kanalimizda birinchi bo‘lib biling.", "soon.cta": "Kanalga obuna bo‘lish",
    "fav.title": "Sevimlilar", "fav.add": "Sevimlilarga qo‘shildi", "fav.rm": "Sevimlilardan olindi", "fav.empty": "Saqlash uchun mahsulotdagi ♡ ni bosing.",
    "cat.fav": "♡ Sevimlilar", "nav.tg": "Telegram"
  });
